...
There are a few different solutions, each with its own ups and downs. The solution proposed here will become practical also when using docker containers to deploy shiny applications. We define a public group, containing the *shiny* user  plus  each user
~~~
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkwODA1ODIxNiwxMjEwMzQ4NDkyLC00NT
